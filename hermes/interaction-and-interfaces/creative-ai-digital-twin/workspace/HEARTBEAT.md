...
- Monitor Creative TV chat per `CREATIVE_TV_WS_URL`.
- Distribute social tokens to engaged viewers.
- Clip highlights via Livepeer when engagement spikes.
- Log autonomous actions to `TRANSACTIONS.md` and `MARKETS.md`.
