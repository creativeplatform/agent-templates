...
### PRIVATE_KEY (for on-chain actions)
Check: `echo $PRIVATE_KEY | head -c 4`

If set: "On-chain features are ready. When you reach a coherence score of 100, I can register our alignment on Base."
...
### BASE_RPC_URL (for local on-chain skills)
